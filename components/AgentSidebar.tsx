      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto custom-scrollbar px-4 py-6">
            ...
            {isLoading ? (
              <div className="text-xs text-slate-500 dark:text-slate-400 px-2">Loading menu…</div>
            ) : (
              <div className="space-y-1">
                {filteredItems.map((item) => {
                        ...
                        <div
                          className={clsx(
                            "group relative block rounded-lg transition-all duration-200 cursor-pointer p-2",
                            {
                              ...
                              "hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white": !isDropdownOpen,
                            }
                          )}
                          onClick={() => {
                                  ...
                                  <div
                                    className={clsx(
                                      ...
                                      child.description ? "p-2.5" : "p-1.5",
                                      {
                                        ...
                                        "hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white": !childActive,
                                      }
                                    )}
                                        ...
                                        <div
                                          className={clsx(
                                            "font-medium text-xs transition-colors duration-200",
                                            {
                                              ...
                                              "text-slate-900 dark:text-slate-200 group-hover:text-slate-900 dark:group-hover:text-white": !childActive,
                                            }
                                          )}
                                        >
                                          {child.label}
                      ...
                      <Link key={item.path} href={item.path}>
                        <div
                          className={clsx(
                            "group relative block rounded-lg transition-all duration-200 cursor-pointer p-2",
                            {
                              ...
                              "hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white": !isActive,
                            }
                          )}
                        ...
                        >
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div className="flex-1 min-w-0">
                              <div
                                className={clsx("font-medium text-xs transition-colors duration-200", {
                                  "text-white": isActive,
                                  "text-slate-900 dark:text-slate-200 group-hover:text-slate-900 dark:group-hover:text-white": !isActive,
                                })}
                              >
                                {item.label}
                              </div>
                            ...
                            <div
                              className={clsx("transition-all duration-200 flex-shrink-0 text-slate-400 dark:text-slate-500", {
                  ...
                  return (
                    <div key={item.label} className="px-3 py-2 font-semibold text-slate-700 dark:text-slate-300 flex items-center space-x-3">
            ...
            <div className="p-4 border-b border-slate-200 relative flex-shrink-0">
              ...
              <div className="pr-16">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-zinc-800/40 border border-slate-200 dark:border-zinc-800">
                  ...
                  <div>
                    <span className="font-semibold text-sm text-slate-900 dark:text-slate-100 block">Staff Portal</span>
                    <span className="text-xs text-sky-600 dark:text-sky-400 font-medium">Staff management</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              {isLoading ? (
                ...
                <div className="space-y-1">
                  {filteredItems.map((item) => {
                        ...
                        <div key={item.label}>
                          <div
                            className={clsx(
                              ...
                              {
                                "bg-sky-600 text-white shadow-sm": isDropdownOpen,
                                "hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-slate-300 active:bg-slate-100 dark:active:bg-zinc-800": !isDropdownOpen,
                              }
                            )}
                            onClick={() => {
                              setOpenDropdown(isDropdownOpen ? null : item.label);
                              ...
                              <div
                                className={clsx(
                                  "text-lg p-2 rounded-lg transition-all duration-200 relative flex-shrink-0",
                                  {
                                    ...
                                    "text-slate-500 dark:text-slate-400 group-hover:text-sky-600 dark:group-hover:text-sky-400 group-hover:bg-sky-50 dark:group-hover:bg-zinc-700": !isDropdownOpen,
                                  }
                                )}
                              >
                                {item.icon}
                                ...
                                <div
                                  className={clsx(
                                    "font-medium text-sm transition-colors duration-200",
                                    {
                                      ...
                                      "text-slate-900 dark:text-slate-100": !isDropdownOpen,
                                    }
                                  )}
                                >
                                  {item.label}
                                  ...
                                  <div
                                    className={clsx(
                                      "text-xs mt-0.5 transition-all duration-200",
                                      {
                                        ...
                                        "text-slate-500 dark:text-slate-400": !isDropdownOpen,
                                      }
                                    )}
                                  >
                                    {item.description}
                                  ...
                                  <Link key={child.path} href={child.path!}>
                                    <div
                                      className={clsx(
                                        ...
                                        {
                                          "bg-sky-600 text-white shadow-sm": childActive,
                                          "hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-slate-300 active:bg-slate-100 dark:active:bg-zinc-800": !childActive,
                                        }
                                      )}
                                      onClick={() => {
                                        handleItemClick();
                                      ...
                                      <div className="flex items-center space-x-2">
                                        <div
                                          className={clsx(
                                            ...
                                            {
                                              "bg-white/20 text-white": childActive,
                                              "text-slate-500 dark:text-slate-400 group-hover:text-sky-600 dark:group-hover:text-sky-400 group-hover:bg-sky-50 dark:group-hover:bg-zinc-700": !childActive,
                                            }
                                          )}
                                        >
                                          {child.icon}
                                        ...
                                        <div className="flex-1 min-w-0">
                                          <div
                                            className={clsx(
                                              ...
                                              {
                                                "text-white": childActive,
                                                "text-slate-900 dark:text-slate-100": !childActive,
                                              }
                                            )}
                                          >
                                            {child.label}
                                          ...
                                          {child.description && (
                                            <div
                                              className={clsx(
                                                ...
                                                {
                                                  "text-white/80": childActive,
                                                  "text-slate-500 dark:text-slate-400": !childActive,
                                                }
                                              )}
                                            >
                                              {child.description}
                        ...
                        <Link key={item.path} href={item.path}>
                          <div
                            className={clsx(
                              ...
                              {
                                "bg-sky-600 text-white shadow-sm": isActive,
                                "hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-slate-300 active:bg-slate-100 dark:active:bg-zinc-800": !isActive,
                              }
                            )}
                            onClick={() => {
                              // Don't set selectedItem - let pathname matching handle active state
                            ...
                            <div className="flex items-center space-x-3">
                              <div
                                className={clsx(
                                  ...
                                  {
                                    "bg-white/20 text-white": isActive,
                                    "text-slate-500 dark:text-slate-400 group-hover:text-sky-600 dark:group-hover:text-sky-400 group-hover:bg-sky-50 dark:group-hover:bg-zinc-700": !isActive,
                                  }
                                )}
                              >
                                {item.icon}
                    ...
                    return (
                      <div key={item.label} className="px-3 py-2 font-semibold text-slate-700 dark:text-slate-300 flex items-center space-x-3 touch-manipulation">
                        <div className="text-lg p-2 rounded-lg bg-slate-100 dark:bg-zinc-800 text-slate-600 dark:text-slate-400">{item.icon}</div>
