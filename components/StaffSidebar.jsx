  ...
  return (
    <>
      ...
      <button
        ...
        className={clsx(
          "fixed top-4 left-4 z-[100] bg-white text-[#2D9AA5] p-3 rounded-lg shadow-lg transition-all duration-300 border-2 border-gray-300 hover:bg-gray-50 hover:border-gray-400 lg:hidden touch-manipulation",
          {
            'block': !isMobileOpen,
            'hidden': isMobileOpen
          }
