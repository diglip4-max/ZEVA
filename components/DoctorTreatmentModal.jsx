          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div className="flex gap-1 border-b border-gray-200 overflow-x-auto">
              <button
                ...
                className={`px-4 py-3 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === "department"
                    ...
                    <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                      {selectedTreatment.subcategories.map((sub) => {
                        ...
                        return (
                          <label
                            key={value}
                            className={`flex items-center gap-3 border rounded-lg px-3 py-2.5 cursor-pointer transition-colors ${selectedSubcategories.includes(value)
