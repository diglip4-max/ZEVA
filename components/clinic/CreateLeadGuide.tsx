      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">
                Create Lead - Complete Guide
              </h1>
              <p className="text-purple-100 text-sm">
                Comprehensive guide for creating and managing leads in your CRM
                system
              </p>
            </div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8 shadow-sm">
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1 text-xs text-blue-700">
              <li>
                <strong>Create Leads:</strong> Add new potential customers with
                complete contact information
              </li>
              <li>
                <strong>Track Sources:</strong> Monitor where leads are coming
                from (website, referral, social media)
              </li>
              <li>
                <strong>Follow-up System:</strong> Schedule and track all lead
                communications
              </li>
              <li>
                <strong>Conversion Funnel:</strong> Convert qualified leads into
                patients/customers
              </li>
            </ul>
          </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-l-4 border-purple-500 p-6 rounded-r-lg">
              ...
              <div className="ml-10 space-y-4">
                <p className="text-base text-purple-800 leading-relaxed">
                  The Create Lead module helps you capture and manage potential
                  customers who have shown interest in your clinic's services.
                  This is the first step in your sales funnel where prospects
                  enter your CRM system.
                </p>
                ...
                <div className="bg-white rounded-lg border border-purple-200 p-4">
                  ...
                  <p className="text-sm text-purple-700 leading-relaxed mb-3">
                    A lead is a person or organization that has expressed
                    interest in your clinic's services through various channels
                    (website inquiry, phone call, walk-in, social media, etc.)
                    but hasn't yet become a paying patient/customer.
                  </p>
                ...
                <div className="bg-white rounded-lg border border-purple-200 p-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm text-purple-700">
                    <li>
                      <strong>Create New Leads:</strong> Manually add prospect
                      information into the system
                    </li>
                    <li>
                      <strong>Capture Contact Details:</strong> Store name,
                      phone, email, location
                    </li>
                    <li>
                      <strong>Track Lead Source:</strong> Record how they found
                      your clinic
                    </li>
                    <li>
                      <strong>Note Requirements:</strong> Document their
                      specific needs/interests
                    </li>
                    <li>
                      <strong>Assign Status:</strong> Categorize as New,
                      Contacted, Qualified, Converted, or Lost
                    </li>
                    <li>
                      <strong>Schedule Follow-ups:</strong> Set reminders for
                      next contact
                    </li>
                    <li>
                      <strong>Add Notes:</strong> Record all interactions and
                      communications
                    </li>
                    <li>
                      <strong>Convert to Patient:</strong> Move qualified leads
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm text-purple-700">
                    <li>
                      <strong>Quick Entry Form:</strong> Fast lead creation with
                      essential fields
                    </li>
                    <li>
                      <strong>Source Tracking:</strong> Multiple lead source
                      options (Website, Walk-in, Referral, Social Media, etc.)
                    </li>
                    <li>
                      <strong>Contact Information:</strong> Complete details
                      storage (name, phone, email, location)
                    </li>
                    <li>
                      <strong>Service Interest:</strong> Record which
                      service/treatment they're interested in
                    </li>
                    <li>
                      <strong>Status Management:</strong> Track lead progression
                      through sales funnel
                    </li>
                    <li>
                      <strong>Follow-up Reminders:</strong> Never miss a
                      scheduled follow-up
                    </li>
                    <li>
                      <strong>Communication History:</strong> Log all calls,
                      emails, messages
                    </li>
                    <li>
                      <strong>Conversion Tracking:</strong> Monitor
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm text-purple-700">
                    <li>
                      <strong>Website Inquiry:</strong> Someone fills out
                      contact form on website → Create lead immediately
                    </li>
                    <li>
                      <strong>Phone Call:</strong> Prospect calls asking about
                      teeth whitening → Create lead during call
                    </li>
                    <li>
                      <strong>Social Media:</strong> Instagram DM about dental
                      implants → Create lead from message
                    </li>
                    <li>
                      <strong>Referral:</strong> Existing patient refers
                      friend/family → Create referred lead
                    </li>
                    <li>
                      <strong>Event/Walk-in:</strong> Health camp or clinic
                      visit → Create lead on spot
                    </li>
                    <li>
                      <strong>Marketing Campaign:</strong> Response to
                      Google/Facebook ads → Create lead from campaign
                    </li>
                    <li>
                      <strong>Corporate Tie-up:</strong> Company inquiry for
                      employee dental plans → Create B2B lead
                    </li>
                  </ul>
                </div>
                ...
                <div className="mt-6 bg-white rounded-lg border-2 border-dashed border-purple-300 p-6">
                  ...
                  <div className="bg-purple-50 rounded-lg p-8 text-center border-2 border-dashed border-purple-200">
                    <p className="text-purple-700 text-sm mb-2">
                      <strong>Upload:</strong> /create-lead-main-page.png
                    </p>
                    <p className="text-purple-600 text-xs">
                      Drag & drop or click to upload screenshot of main create
                      lead page
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 p-6 rounded-r-lg">
              ...
              <div className="ml-10 space-y-4">
                <p className="text-base text-green-800 leading-relaxed">
                  Creating a new lead is a simple process. Fill in the
                  prospect's information, select their interest, and set up
                  follow-up reminders to ensure proper tracking.
                </p>
                  ...
                  <div className="space-y-3">
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Required Field</strong> - Enter the lead's first
                        name
                      </p>
                    ...
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Optional Field</strong> - Enter the lead's last
                        name or family name
                      </p>
                      <ul className="list-disc list-inside ml-5 space-y-1 text-xs text-green-700">
                    ...
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Optional but Recommended</strong> - Primary
                      ...
                      <ul className="list-disc list-inside ml-5 space-y-1 text-xs text-green-700">
                        ...
                        <li>
                          Used for email marketing campaigns (if opted in)
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Required Field</strong> - Primary contact number
                      </p>
                      <ul className="list-disc list-inside ml-5 space-y-1 text-xs text-green-700">
                    ...
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Optional Field</strong> - City or area where
                        lead resides
                      </p>
                      <ul className="list-disc list-inside ml-5 space-y-1 text-xs text-green-700">
                        <li>
                          Examples: "Dubai", "Abu Dhabi", "Sharjah", "Jumeirah"
                        </li>
                    ...
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Required Field</strong> - How did they find your
                        clinic?
                      </p>
                      <ul className="list-disc list-inside ml-5 space-y-1 text-xs text-green-700">
                        <li>
                          Common options: Website, Walk-in, Phone Call,
                          Facebook, Instagram, Google, Referral, Other
                        </li>
                    ...
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Optional Field</strong> - Which service are they
                        interested in?
                      </p>
                      <ul className="list-disc list-inside ml-5 space-y-1 text-xs text-green-700">
                        <li>
                          Examples: Dental Implants, Teeth Whitening,
                    ...
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      <p className="font-semibold text-green-900 mb-1">
                        8. Initial Notes/Requirements
                      </p>
                      <p className="text-xs text-green-700 mb-2">
                        <strong>Optional Field</strong> - Additional details
                        about their needs
                      </p>
                      <ul className="list-disc list-inside ml-5 space-y-1 text-xs text-green-700">
                        <li>
                          Example: "Interested in Invisalign consultation,
                ...
                <div className="bg-white rounded-lg border border-green-200 p-4">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-sm text-green-700">
                    <li>
                      <strong>Navigate to Create Lead:</strong> Go to
                      /clinic/create-lead
                    </li>
                    <li>
                      <strong>Form Appears:</strong> Lead creation form is
                      displayed
                    </li>
                    <li>
                      <strong>Enter First Name:</strong> Type lead's first name
                      (required)
                    </li>
                    <li>
                      <strong>Enter Last Name:</strong> Optionally add last name
                    </li>
                    <li>
                      <strong>Add Email:</strong> Input email address if
                      available
                    </li>
                    <li>
                      <strong>Add Phone:</strong> Enter primary contact number
                      (required)
                    </li>
                    <li>
                      <strong>Select Location:</strong> Choose city/area from
                      dropdown or type
                    </li>
                    <li>
                      <strong>Choose Source:</strong> Select how they found your
                      clinic (required)
                    </li>
                    <li>
                      <strong>Select Service:</strong> Pick service they're
                      interested in
                    </li>
                    <li>
                      <strong>Add Notes:</strong> Write any additional
                      requirements or comments
                    </li>
                    <li>
                      <strong>Click Save:</strong> Submit the form to create
                      lead
                    </li>
                    <li>
                      <strong>Confirmation:</strong> Success message appears
                      with lead ID
                    </li>
                    <li>
                      <strong>Set Follow-up:</strong> Schedule next contact
                      date/time if needed
                    </li>
                  </ol>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm text-green-700">
                    <li>
                      <strong>Speed Matters:</strong> Create leads immediately
                      while information is fresh
                    </li>
                    <li>
                      <strong>Complete Information:</strong> Capture as many
                      details as possible for better follow-up
                    </li>
                    <li>
                      <strong>Accurate Source:</strong> Always record correct
                      lead source for marketing analysis
                    </li>
                    <li>
                      <strong>Clear Notes:</strong> Write detailed notes so
                      anyone can follow up effectively
                    </li>
                    <li>
                      <strong>Quick Follow-up:</strong> Contact new leads within
                      24 hours for best conversion
                    </li>
                    <li>
                      <strong>WhatsApp Enabled:</strong> Mark if phone number
                      has WhatsApp for modern communication
                    </li>
                    <li>
                      <strong>Privacy Compliance:</strong> Ensure consent for
                      communication (GDPR/local regulations)
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white rounded-lg border border-green-200 p-4">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="py-2 px-3">
                            Interested in premium whitening, wants appointment
                            next week
                          </td>
                        </tr>
                      </tbody>
                  ...
                  <p className="text-xs text-green-600 mt-2 italic">
                    This lead should be contacted within 24 hours for best
                    conversion rate
                  </p>
                </div>
                ...
                <div className="mt-6 bg-white rounded-lg border-2 border-dashed border-green-300 p-6">
                  ...
                  <div className="bg-green-50 rounded-lg p-8 text-center border-2 border-dashed border-green-200">
                    <p className="text-green-700 text-sm mb-2">
                      <strong>Upload:</strong> /create-lead-form.png
                    </p>
                    <p className="text-green-600 text-xs">
                      Drag & drop or click to upload screenshot of lead creation
                      form
                    </p>
                  </div>
                </div>
        ...
        {activeSection === "lead-fields" && (
          <div className="bg-white rounded-lg p-8 text-center border-2 border-dashed border-purple-300">
            ...
            <p className="text-purple-700 mb-4">
              Detailed explanation of all lead fields:
            </p>
        ...
        {activeSection === "lead-sources" && (
          <div className="bg-white rounded-lg p-8 text-center border-2 border-dashed border-purple-300">
            ...
            <p className="text-purple-700 mb-4">
              Understanding and tracking lead sources:
            </p>
            <ul className="list-disc list-inside text-sm text-purple-600">
        ...
        {activeSection === "follow-up" && (
          <div className="bg-white rounded-lg p-8 text-center border-2 border-dashed border-purple-300">
            ...
            <p className="text-purple-700 mb-4">
              Managing lead follow-ups effectively:
            </p>
            <ul className="list-disc list-inside text-sm text-purple-600">
