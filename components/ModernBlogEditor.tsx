  ...
  useEffect(() => {
    ...
    autoSaveTimerRef.current = setInterval(() => {
      ...
      if (currentDraftId || editDraftId) {
        ...
        if (hasRealContent) {
          console.log('Auto-save: Updating existing draft');
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-5 md:p-6 max-w-md w-full mx-2 sm:mx-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-2 sm:space-y-3">
              <button
                ...
                className="w-full flex items-center gap-2 sm:gap-3 p-3 sm:p-4 border-2 border-gray-200 rounded-lg sm:rounded-xl hover:border-purple-500 hover:bg-purple-50 transition-all group"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
            ...
            <div className="w-full md:w-72 lg:w-80 flex-shrink-0">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <input
                  ...
                  className="flex-1 min-w-0 px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
            </div>
          </div>
            ...
            <div className="absolute top-1 right-1 sm:top-2 sm:right-2 md:top-3 md:right-3 lg:top-4 lg:right-4 z-[100]" style={{ position: 'absolute', pointerEvents: 'auto' }}>
              <div className="relative">
                ...
                <button
                  ...
                  className="w-8 h-8 sm:w-10 sm:h-10 md:w-11 md:h-11 lg:w-12 lg:h-12 bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all transform hover:scale-110"
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 pb-4 sm:pb-6">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                  {topics.map((topic) => (
                    <span
                      key={topic}
                      className="inline-flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 rounded-full text-xs sm:text-sm font-medium"
                    >
                      #{topic}
                      <button
                ...
                <div className="flex gap-1.5 sm:gap-2">
                  <input
                    ...
                    className="flex-1 px-3 sm:px-4 py-1.5 sm:py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                  <button
                    onClick={addTopic}
                    className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all flex-shrink-0"
                  >
            ...
            <div className="p-3 sm:p-4 border-t border-gray-200 bg-gray-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 flex-shrink-0">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <button
                  ...
                  className="px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-lg text-xs sm:text-sm font-medium transition-all disabled:opacity-50 flex items-center gap-1.5 sm:gap-2"
                >
                  ...
                  <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {topics.map((topic) => (
                        <span
                          key={topic}
                          className="px-2 sm:px-3 py-1 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 rounded-full text-xs sm:text-sm font-medium"
                        >
                          #{topic}
                        </span>
                      ))}
