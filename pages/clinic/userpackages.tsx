...
import {
  ...
  User, AlertCircle, TrendingUp, Eye, X
} from 'lucide-react';
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-4 sm:mb-6 border border-green-100">
            <div className="flex border-b border-green-200">
              <button
                ...
                className={`flex-1 py-3 sm:py-4 px-3 sm:px-6 text-center font-semibold transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm ${activeTab === 'pending'
              ...
              <button
                ...
                className={`flex-1 py-3 sm:py-4 px-3 sm:px-6 text-center font-semibold transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm ${activeTab === 'approved'
