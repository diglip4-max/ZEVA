      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {activeTab === 'Offers' ? (
          <div className="-mx-4 sm:-mx-6 lg:-mx-8">
            <OffersComponent dateFilter={dateFilter} setActiveTab={setActiveTab} />
          </div>
        ) : activeTab === 'Create Offer' ? (
          <div className="-mx-4 sm:-mx-6 lg:-mx-8 p-4">
            <CreateOfferWizard
              onCancel={() => setActiveTab('Offers')}
              onCreated={() => setActiveTab('Offers')}
              token={typeof window !== 'undefined' ? (localStorage.getItem("clinicToken") || sessionStorage.getItem("clinicToken") || "") : ""}
            />
          </div>
        ) : activeTab === 'Overview' ? (
