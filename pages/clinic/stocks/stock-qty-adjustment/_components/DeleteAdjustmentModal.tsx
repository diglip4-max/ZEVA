...
const DeleteAdjustmentModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onConfirm,
  adjustmentNo = "",
  ...
  const displayName = adjustmentNo || title || "Stock Adjustment";
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              You're about to delete the stock adjustment{" "}
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    ...
                    stock adjustment will be permanently removed.
                  </p>
                </div>
              </div>
            </div>
