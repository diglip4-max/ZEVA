...
const DeleteUomModal: React.FC<DeleteUomModalProps> = ({
  ...
  const confirmationPhrase = "DELETE"; // You can also use uomName here
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">
              Are you sure you want to delete this unit of measurement? This will permanently remove the
              unit from your inventory system.
            </p>
              ...
              <div className="flex items-start">
                ...
                <div className="text-left">
                  ...
                  <p className="text-yellow-700 text-xs">
                    Products currently using this UOM will need to be updated to use a different unit of measurement.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <ul className="text-left text-xs text-gray-600 space-y-2">
                <li className="flex items-start">
                  ...
                  <span>Unit of measurement will be permanently deleted</span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>Associated product records will be affected</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0"
                  ...
                  <span>You will need to update products using this UOM</span>
                </li>
              </ul>
            </div>
                ...
                {!validationError &&
                  confirmationText.trim().toUpperCase() ===
                    ...
                    <p className="text-green-600 text-xs mt-1 flex items-center">
                      ...
                      Confirmed! You can now delete the UOM.
                    </p>
                  )}
              </div>
