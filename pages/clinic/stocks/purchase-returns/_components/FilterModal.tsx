        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                type="text"
                value={filterData.purchaseReturnNo}
                onChange={(e) =>
                  setFilterData((prev) => ({
                    ...prev,
                    purchaseReturnNo: e.target.value,
                  }))
                }
            ...
            <div className="space-y-2">
              ...
              <input
                type="text"
                value={filterData.purchasedOrder}
                onChange={(e) =>
                  setFilterData((prev) => ({
                    ...prev,
                    purchasedOrder: e.target.value,
                  }))
                }
