...
const DeletePurchaseReturnModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onConfirm,
  loading = false,
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden flex flex-col">
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              You're about to delete the purchase return{" "}
              <span className="font-semibold text-gray-900">"{prNo}"</span>.
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    ...
                    purchase return may be affected.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className={`w-full px-3 py-2 text-gray-500 border rounded-md shadow-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm ${validationError ? "border-red-300 placeholder-red-300" : "border-gray-300"}`}
              disabled={loading}
            />
            {validationError && (
        ...
        <div className="bg-gray-50 px-4 py-3 flex justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2.5 text-sm font-medium text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700 disabled:opacity-50 flex items-center gap-2"
          >
            {loading ? (
              <>
                <svg
