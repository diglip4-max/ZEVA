      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-8 text-center max-w-md">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-400 mb-4">
            You do not have permission to view stock transfer requests. Please contact your administrator.
          </p>
                              ...
                              <div className="py-1" role="none">
                                ...
                                <button
                                  onClick={() => {
                                    ...
                                    const printUrl = `/clinic/stocks/stock-transfer/print-stock-transfer-request/?strId=${r?._id}`;
                                    window.open(
                                      printUrl,
                                      "_blank",
                                      "noopener,noreferrer",
...
StockTransferRequestPage.getLayout = function getLayout(page: ReactElement) {
  return (
...
const ProtectedStockTransferRequestPage = withClinicAuth(
  StockTransferRequestPage,
) as NextPageWithLayout;
ProtectedStockTransferRequestPage.getLayout =
  StockTransferRequestPage.getLayout;

export default ProtectedStockTransferRequestPage;
