...
const DeleteDirectStockTransferModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onConfirm,
  loading = false,
        ...
        <div className="px-4 py-6 bg-white">
          <div className="mb-4">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded px-3 py-2">
              <p className="text-sm font-medium text-gray-900">{dstNo}</p>
            </div>
          </div>
...
export default DeleteDirectStockTransferModal;
