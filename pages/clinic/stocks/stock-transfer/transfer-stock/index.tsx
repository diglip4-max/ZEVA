...
const MODULE_KEY = "clinic_stock_transfer_on_request";
          ...
          if (res.data.success) {
            if (res.data.permissions === null || !Array.isArray(res.data.permissions) || res.data.permissions.length === 0) {
              ...
              let modulePermission = res.data.permissions.find((p: any) => {
                ...
                if (p.module === "clinic_stock_transfer_on_request") return true;
                if (p.module === "transfer_on_request") return true;
                if (p.module === "stock_transfer_on_request") return true;
                return false;
              });
              ...
              if (!modulePermission) {
                ...
                if (parentStockModule) {
                  modulePermission = parentStockModule.subModules.find((sm: any) =>
                    sm?.moduleKey === "clinic_stock_transfer_on_request"
                  );
                }
              }
              if (modulePermission) {
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-8 text-center max-w-md">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-400 mb-4">
            You do not have permission to view transfer stocks. Please contact your administrator.
          </p>
        </div>
      </div>
    );
    ...
    <div>
      <div className="bg-bg-surface border-b border-border-default px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-text-primary">Transfer Stock</h1>
