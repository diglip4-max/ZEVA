...
interface DeleteCustomStockItemModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  itemName?: string;
...
const DeleteCustomStockItemModal: React.FC<DeleteCustomStockItemModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  itemName = "Custom Stock Item",
  loading = false,
}) => {
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">
              Are you sure you want to delete this custom stock item? This will permanently remove it from your inventory system.
            </p>
                ...
                {!validationError &&
                  confirmationText.trim().toUpperCase() ===
                    ...
                    <p className="text-green-600 text-xs mt-1 flex items-center">
                      ...
                      Confirmed! You can now delete the item.
                    </p>
                  )}
              </div>
...
export default DeleteCustomStockItemModal;
