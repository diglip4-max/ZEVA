...
const DeleteProviderModal: React.FC<DeleteProviderModalProps> = ({
  ...
  loading = false,
  includeCascadeWarning = true,
}) => {
  const [confirmationText, setConfirmationText] = useState("");
  const [validationError, setValidationError] = useState("");
  const confirmationPhrase = "DELETE_PROVIDER";
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden flex flex-col">
        ...
        <div className="bg-red-50 px-4 py-3 flex justify-between items-center border-b border-red-200">
          <div>
            ...
            <p className="text-red-700 text-[10px] sm:text-xs mt-0.5">
              This will permanently delete the provider and all associated data
            </p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="p-4 sm:p-6 max-h-[75vh] overflow-y-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">
              Are you sure you want to delete this provider? This action will{" "}
              <strong className="text-red-600">permanently delete</strong> all
              data associated with this provider.
            </p>

            {/* Cascade Warning */}
            {includeCascadeWarning && hasDependencies && (
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-red-700 text-xs mb-2">
                      Deleting this provider will also delete all associated
                      data:
                    </p>
                    <ul className="text-red-700 text-xs space-y-1">
                      <li className="flex items-start">
                        <svg
                          className="w-3 h-3 text-red-500 mr-1.5 mt-0.5"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                        ...
                        <span>All templates will be deleted</span>
                      </li>
                      <li className="flex items-start">
                        <svg
                          className="w-3 h-3 text-red-500 mr-1.5 mt-0.5"
                        ...
                        <span>All messages will be deleted</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-green-700 text-xs">
                      This provider has no templates or messages associated with
                      it.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <ul className="text-left text-xs text-gray-600 space-y-2">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Provider configuration</strong> and settings
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>All templates associated with this provider</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-4 h-4 text-red-500 mr-2 mt-0.5 flex-shrink-0"
                  ...
                  <span>All messages sent through this provider</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-4 h-4 text-red-500 mr-2 mt-0.5 flex-shrink-0"
                  ...
                  <span>
                    All <strong>API keys, credentials</strong> and connection
                    data
                  </span>
                </li>
              </ul>
            ...
            <div className="space-y-2">
              <div className="text-left">
                ...
                <input
                  ...
                  className={clsx(
                    "w-full text-gray-600 px-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm transition-colors",
                    validationError
                ...
                {!validationError &&
                  confirmationText.trim().toUpperCase() ===
                    ...
                    <p className="text-green-600 text-xs mt-1 flex items-center">
                      ...
                      Confirmed! This will delete all associated data.
                    </p>
                  )}
              </div>
        ...
        <div className="border-t bg-gray-50 px-4 py-3 flex justify-end gap-2">
          <button
            onClick={handleClose}
            disabled={loading}
            className="cursor-pointer px-4 py-2 rounded-lg border border-gray-200 text-gray-700 text-xs sm:text-sm font-medium hover:bg-gray-100 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            ...
            className={clsx(
              "cursor-pointer px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors",
              isConfirmDisabled
          ...
          >
            {loading ? (
              ...
              `Delete Provider${hasDependencies ? " & All Data" : ""}`
            )}
          </button>
        </div>
      </div>
