...
function InvoicesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50" style={{ width: '100%', padding: '0', margin: '0' }}>
      <div className="p-2 sm:p-3 md:p-4 lg:p-6" style={{ width: '100%', minWidth: '100%' }}>
        <div className="w-full" style={{ width: '100%', overflowX: 'visible' }}>
          {/* Header Section */}
          <div className="bg-white rounded-2xl shadow-lg border border-indigo-100 mb-4 sm:mb-6 overflow-hidden">
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-4 sm:px-6 py-4 sm:py-6">
            ...
            <div className="px-4 sm:px-6 py-4 sm:py-5">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-6 py-3 text-sm border-2 border-indigo-100 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-indigo-900 bg-white transition-all duration-200"
                />
              </div>
            </div>
          </div>
          ...
          {/* Filters Section */}
          {showFilters && (
            <div className="bg-white rounded-2xl shadow-lg border border-indigo-100 mb-4 sm:mb-6 p-4 sm:p-6">
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4 sm:p-5 border border-indigo-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-indigo-700 mb-2 uppercase tracking-wider">
                      From Date
                    </label>
                    <input
                      type="date"
                      ...
                      className="w-full px-4 py-2.5 text-sm border-2 border-indigo-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-indigo-900 bg-white transition-all duration-200"
                    />
                  </div>
                ...
                <div className="mt-6 flex justify-end gap-3">
                  <button
                    ...
                    className="px-5 py-2.5 text-sm text-indigo-700 bg-white border-2 border-indigo-200 rounded-lg hover:bg-indigo-50 hover:border-indigo-300 transition-all duration-200 font-medium"
                  >
                    Clear All
                  </button>
                  <button
                    onClick={applyFilters}
                    className="px-5 py-2.5 text-sm text-white bg-gradient-to-r from-indigo-600 to-purple-600 border-2 border-indigo-600 rounded-lg hover:from-indigo-700 hover:to-purple-700 hover:border-indigo-700 transition-all duration-200 font-medium shadow-md hover:shadow-lg"
                  >
                    Apply Filters
                  </button>
                </div>
          ...
          {/* Summary Stats */}
          <div className="mb-4 sm:mb-6 text-sm text-indigo-700 bg-white px-4 py-3 rounded-xl shadow-sm border border-indigo-100 flex items-center gap-2">
            <span className="font-semibold">Showing</span>
            <span className="font-bold text-indigo-900">{complaints.length}</span>
            <span>of</span>
          ...
          {/* Loading State */}
          {loading ? (
            <div className="min-h-[400px] bg-white rounded-2xl shadow-lg border border-indigo-100 flex items-center justify-center p-12">
              <div className="flex flex-col items-center gap-4">
                <div className="w-12 h-12 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div>
                <p className="text-indigo-700 text-lg font-medium">Loading invoices...</p>
              </div>
            </div>
          ) : error ? (
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-indigo-100 p-12 text-center">
              <div className="flex flex-col items-center gap-4">
                <div className="w-20 h-20 bg-indigo-50 rounded-full flex items-center justify-center">
                  <FileText className="h-10 w-10 text-indigo-400" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-indigo-900 mb-2">No Invoices Found</h3>
                  <p className="text-indigo-600">There are no complaints matching your criteria.</p>
                </div>
              </div>
            </div>
          ) : (
            /* Main Table Section */
            <div className="bg-white rounded-2xl shadow-lg border border-indigo-100 overflow-hidden" style={{ width: '100%', display: 'flex', flexDirection: 'column' }}>
              <div className="px-6 py-3 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-indigo-100 text-xs sm:text-sm text-indigo-700 flex items-center justify-center gap-2">
                  ...
                  <tbody className="bg-white">
                    {complaints.map((comp, index) => {
                      ...
                      return (
                        <tr 
                          key={comp._id} 
                          className={`transition-all duration-200 ${isEven ? 'bg-white' : 'bg-indigo-50/30'} hover:bg-gradient-to-r from-indigo-50 to-purple-50 cursor-default`}
                        >
                          <td className="px-4 py-4 whitespace-nowrap border-b border-indigo-100">
                            <div className="text-sm">
                              <div className="font-semibold text-indigo-900 text-base">{comp.patientName}</div>
                              <div className="text-indigo-600 text-xs mt-1 flex items-center gap-2 flex-wrap">
                          ...
                          <td className="px-4 py-4 whitespace-nowrap border-b border-indigo-100">
                            <div className="text-sm text-indigo-900 font-medium">{comp.doctorName}</div>
                          </td>
                          <td className="px-4 py-4 whitespace-nowrap border-b border-indigo-100">
                            <div className="text-sm">
                              <div className="text-indigo-900 flex items-center gap-2">
                          ...
                          <td className="px-4 py-4 border-b border-indigo-100">
                            <div className="text-sm text-indigo-900 max-w-[200px]">
                          ...
                          <td className="px-4 py-4 border-b border-indigo-100">
                            {comp.complaintNote && comp.complaintNote.length > 50 ? (
                              <button
                                ...
                                className="text-left text-sm text-indigo-700 hover:text-indigo-900 hover:underline font-medium max-w-[180px] truncate"
                              >
                                {comp.complaintNote.substring(0, 50)}...
                              </button>
                            ) : (
                              <div className="text-sm text-indigo-900 max-w-[180px]">
                                {comp.complaintNote || "-"}
                              </div>
                            )}
                          </td>
                          ...
                          <td className="px-4 py-4 whitespace-nowrap border-b border-indigo-100 text-center">
                            <div className="relative inline-block">
                              <button
                                onClick={() => handleActionClick(comp._id)}
                                className="p-2 text-indigo-600 hover:text-indigo-900 rounded-full hover:bg-indigo-100 transition-all duration-200"
                              >
                              ...
                              {openActionMenu === comp._id && (
                                <>
                                  ...
                                  />
                                  <div className="absolute right-0 top-full mt-2 z-50 bg-white rounded-xl shadow-2xl border border-indigo-200 min-w-[140px] overflow-hidden">
                                    <button
                                      onClick={() => handleBillingClick(comp.appointment)}
                                      className="w-full text-left px-4 py-3 text-sm text-indigo-900 hover:bg-indigo-50 flex items-center gap-2 transition-all duration-200"
                                    >
              ...
              {/* Pagination */}
              {totalPages > 1 && (
                <div className="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-indigo-50 to-purple-50 border-t border-indigo-100">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="px-4 py-2 text-sm bg-white border-2 border-indigo-200 rounded-lg hover:bg-indigo-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium text-indigo-700"
                    >
                      ← Previous
                    </button>
                    <button
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-6 overflow-y-auto max-h-[60vh]">
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-100">
                <p className="text-indigo-900 text-lg leading-relaxed whitespace-pre-wrap">
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end">
              <button
                onClick={() => setSelectedComplaintNote(null)}
                className="px-6 py-2.5 text-sm text-indigo-700 bg-white border-2 border-indigo-200 rounded-lg hover:bg-indigo-50 hover:border-indigo-300 transition-all duration-200 font-medium"
              >
                Close
              </button>
            </div>
