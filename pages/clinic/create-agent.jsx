...
const ManageAgentsPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 dark:bg-gray-900 py-6 px-4 sm:px-6 lg:px-8">
      ...
      {profileAgent && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-16 bg-black/40 p-4 backdrop-blur-sm">
          <div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg border border-gray200 dark:border-gray700 shadow-xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray300 dark:border-gray600 rounded-md text-xs bg-white dark:bg-gray-700 text-teal-900 dark:text-teal-100"
                >
                ...
                <div className="flex flex-col gap-1.5 overflow-hidden">
                  <label className="flex items-center gap-2 w-full cursor-pointer group">
                    <div className="flex-shrink-0 flex items-center justify-center px-3 py-2 bg-white dark:bg-gray-700 border border-gray300 dark:border-gray600 rounded-md text-xs font-medium text-teal-700 dark:text-teal-200 group-hover:bg-gray-50 dark:group-hover:bg-gray-600 transition-colors shadow-sm">
                      {uploadingIdDoc ? (
                    ...
                    />
                    <span className="text-[11px] text-teal-600 dark:text-teal-400 truncate flex-1 min-w-0">
