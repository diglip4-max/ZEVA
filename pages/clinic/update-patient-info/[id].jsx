...
const InvoiceUpdateSystem = () => {
  ...
  }, [formData, invoiceInfo, authToken, currentUser.name]);
  ...
  }, [claimStatusModal, invoiceInfo, currentUser.name, formData.advanceClaimReleaseDate, formData.advanceClaimReleasedBy, authToken]);
  ...
  }, [formData.status, formData.rejectionNote, formData.advanceClaimReleaseDate, formData.advanceClaimReleasedBy, invoiceInfo, authToken, currentUser.name]);
