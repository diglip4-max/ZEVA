// pages/api/finance/cheques/[id]/index.js
...
export default async function handler(req, res) {
  ...
  try {
    const cheque = await FinanceCheque.findOne({ _id: id, clinicId })
      ...
      .populate("transactionId", "invoiceNumber category amount balance")
      .populate("paymentId", "paymentNumber amount reversed")
    ...
    return res.status(200).json({ success: true, data: cheque });
  } catch (error) {
