      ...
      */
      ...
      if (search) {
        query.$or = [
          ...
          { preheader: { $regex: search, $options: "i" } },
      ...
      const formatedData = Object.keys(groupedMessages)
        ...
        .map((date) => ({
          date,
          messages: groupedMessages[date], // Reverse the messages within each date group
        }));
