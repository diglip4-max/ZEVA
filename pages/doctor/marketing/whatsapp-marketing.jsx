// pages/doctor/marketing/whatsapp-marketing.jsx
...
const WhatsAppSender = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-indigo-50 py-8 px-4">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 mb-6">
          <div className="flex items-center gap-4 mb-2">
            <div className="w-12 h-12 bg-gradient-to-br from-green-600 to-indigo-600 rounded-xl flex items-center justify-center">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
              </svg>
            </div>
            <div>
              <h1 className="text-3xl font-bold text-slate-800">WhatsApp Marketing Campaign</h1>
              <p className="text-slate-600 mt-1">Create and send engaging WhatsApp messages to your customers</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
          {/* Mode Toggle */}
          <div className="bg-gradient-to-r from-slate-50 to-green-50 border-b border-slate-200 p-6">
            ...
            <div className="inline-flex rounded-xl bg-white shadow-sm border border-slate-200 p-1">
              <button
                className={`px-6 py-2.5 rounded-lg font-medium transition-all duration-200 ${mode === "single" ? "bg-gradient-to-r from-green-600 to-indigo-600 text-white shadow-md" : "text-slate-600 hover:bg-slate-50"}`}
                onClick={() => setMode("single")}
              >
                Single Recipient
              </button>
              <button
                className={`px-6 py-2.5 rounded-lg font-medium transition-all duration-200 ${mode === "bulk" ? "bg-gradient-to-r from-green-600 to-indigo-600 text-white shadow-md" : "text-slate-600 hover:bg-slate-50"}`}
          ...
          <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {mode === "single" ? (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-green-500 transition-all"
                  />
                </div>
              ) : (
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-green-500 transition-all resize-none"
                    rows={4}
                  />
                </div>
              )}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-slate-300 rounded-xl p-6 hover:border-green-400 transition-colors">
            ...
            <div className="mt-8 col-span-full">
              <button
                ...
                className="w-full bg-gradient-to-r from-green-600 to-indigo-600 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl disabled:opacity-50"
              >
                {loading ? "Sending Messages..." : "Send WhatsApp Campaign"}
              </button>
            </div>
...
// Layout
WhatsAppSender.getLayout = (page) => <DoctorLayout>{page}</DoctorLayout>;

// Protect and preserve layout
const ProtectedWhatsAppSender = withDoctorAuth(WhatsAppSender);
