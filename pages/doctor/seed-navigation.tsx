...
const SeedNavigationPage: NextPageWithLayout = () => {
  ...
  const role = 'doctor'; // Doctor users can only manage doctor navigation

  const fetchNavigationItems = async () => {
    setFetching(true);
    setError(null);
    try {
      const { data } = await axios.get(`/api/navigation/get-by-role?role=${role}`, {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">View and seed doctor sidebar navigation options</p>
        </div>
        ...
        <div className="mb-6 bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Doctor Navigation Items</h2>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
          <div className="px-5 py-3.5 border-b border-gray-200 bg-gray-50">
            ...
            <p className="text-[11px] text-gray-500 mt-0.5">All sidebar options for doctor role</p>
          </div>
          ...
          {fetching ? (
            ...
            <div className="px-5 py-12 text-center text-gray-500">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Click "Seed Navigation Items" to create navigation items for doctor role
              </p>
            </div>
          ) : (
...
SeedNavigationPage.getLayout = (page: React.ReactNode) => <DoctorLayout>{page}</DoctorLayout>;

const ProtectedSeedNavigationPage: NextPageWithLayout = withDoctorAuth(SeedNavigationPage) as any;
