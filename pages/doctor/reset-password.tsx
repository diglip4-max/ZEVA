// pages/doctor/reset-password.tsx
'use client';
...
export default function ResetDoctorPasswordPage() {
  ...
  useEffect(() => {
    const storedEmail = localStorage.getItem('doctorEmailForReset');
    if (storedEmail) {
  ...
  const handleReset = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await axios.post('/api/doctor/reset-password', { email, password });
      if (res.status === 200) {
        setShowSuccess(true);
      }
    } catch (err: unknown) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-600 to-teal-600 rounded-full mb-4 shadow-lg">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="p-8">
            <form onSubmit={handleReset} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">This email is verified and cannot be changed</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:border-green-500 transition-all duration-200 text-gray-900"
          ...
          <div className="bg-gray-50 px-8 py-4 border-t border-gray-100">
            <div className="flex items-center justify-center text-sm text-gray-600">
              ...
              <Link href="/doctor/login" className="text-green-600 hover:text-green-500 font-medium ml-1">
                Sign in instead
              </Link>
            </div>
          </div>
...
ResetDoctorPasswordPage.getLayout = function PageLayout(page: React.ReactNode) {
