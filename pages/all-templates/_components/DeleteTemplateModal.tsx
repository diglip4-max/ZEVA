        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">
              Are you sure you want to delete this template? This will remove
              the template but will not affect content that has already used it.
            </p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-left">
                    <h4 className="font-bold text-yellow-800 text-sm mb-1">
                      Used in {usageCount} item{usageCount !== 1 ? "s" : ""}
                    </h4>
                    <p className="text-yellow-700 text-xs">
                      The {usageCount} item{usageCount !== 1 ? "s" : ""} that
                      use this template will remain unchanged.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <ul className="text-left text-xs text-gray-600 space-y-2">
                <li className="flex items-start">
                  ...
                  <span>Template will be permanently deleted</span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>
                    Items that used this template will remain in your system
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>No content data will be lost</span>
                </li>
              </ul>
            </div>
                ...
                {!validationError &&
                  confirmationText.trim().toUpperCase() ===
                    ...
                    <p className="text-green-600 text-xs mt-1 flex items-center">
                      ...
                      Confirmed! You can now delete the template.
                    </p>
                  )}
              </div>
