        ...
        {!loading && !error && leads.length === 0 && (
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm px-6 py-12 mt-6 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Once a lead is assigned to you, it will appear in this list with its details.
            </p>
          </div>
        )}
          ...
          <div className="mt-6 space-y-6">
            {leads.map((lead) => {
              ...
              return (
                <div
                  key={lead._id}
                  className={`rounded-2xl border border-slate-200 bg-white/95 backdrop-blur shadow-[0_20px_48px_rgba(15,23,42,0.08)] transition hover:-translate-y-1 hover:border-sky-200 hover:shadow-[0_24px_54px_rgba(14,165,233,0.18)] ${cardBorderClass}`}
                >
                  <div className="grid grid-cols-1 gap-6 px-6 py-5 xl:grid-cols-12">
                    ...
                    <div className="flex flex-col items-end gap-2 xl:col-span-1">
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-emerald-200 transition hover:bg-emerald-600"
                      >
...
const ProtectedAssignedLeadsPage = withAgentAuth(AssignedLeadsPage);
