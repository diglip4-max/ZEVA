// pages/agent/marketing/whatsapp-marketing.jsx
...
// Layout
WhatsAppSender.getLayout = (page) => <AgentLayout>{page}</AgentLayout>;

// Protect and preserve layout
const ProtectedWhatsAppSender = withAgentAuth(WhatsAppSender);
