...
interface DeletePurchaseRequestModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const DeletePurchaseRequestModal: React.FC<DeletePurchaseRequestModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  purchaseRequestName = "Purchase Request",
  loading = false,
}) => {
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              You're about to delete the purchase request{" "}
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    ...
                    purchase request will be permanently removed.
                  </p>
                </div>
              </div>
            </div>
...
export default DeletePurchaseRequestModal;
