      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm mt-1">
                Filter your direct stock transfers
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-bold text-gray-900">
                Direct Stock Transfer No
              </label>
              <input
                type="text"
                value={filterData.directStockTransferNo}
                onChange={(e) =>
                  setFilterData((prev) => ({
                    ...prev,
                    directStockTransferNo: e.target.value,
                  }))
                }
                placeholder="Enter DST number"
                className="w-full px-3 py-2.5 text-sm text-gray-600 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
              />
            </div>
