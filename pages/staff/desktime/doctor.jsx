...
//   console.log('doctor userToken :', token);
...
//         });
//         console.log(`Doctor reported ${type}: ${durationSec}s`);
//       } catch (err) {
...
//           report('mouse-activity', activeSec); // Also count as productive when tab was active
//         }
//         lastActivity = now;
//         clearTimeout(idleTimer);
//       }
...
//           deskTime: `${formatTime(deskTime)} (time on DeskTime website)`,
...
// };
// const ProtectedDoctorDeskTimeDashboard = withStaffAuth(DoctorDeskTimeDashboard);
// ProtectedDoctorDeskTimeDashboard.getLayout = DoctorDeskTimeDashboard.getLayout;
// export default ProtectedDoctorDeskTimeDashboard;
