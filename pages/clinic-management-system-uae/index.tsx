...
const ClinicManagementSystemUAE: React.FC = () => {
  return (
    <>
      <Head>
        <title>Clinic Management System UAE – ZEVA 360</title>
        <meta name="description" content="ZEVA 360 – the complete clinic management system for UAE. Automate follow-ups, reduce no-shows by 40%, and grow revenue with intelligent automation." />
...
export default ClinicManagementSystemUAE;
