...
const FinanceTransactionSchema = new Schema({
  ...
  balance: { type: Number, default: function (this) { return this.amount; } },

  status: {
    type: String,
    enum: ['draft', 'pending', 'upcoming', 'partial', 'paid', 'overdue', 'cancelled'],
    default: 'pending'
  },
...
export const FinanceTransaction =
  models.FinanceTransaction || model('FinanceTransaction', FinanceTransactionSchema);